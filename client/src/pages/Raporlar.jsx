...
const Raporlar = () => {
  ...
  useEffect(() => {
    axios.get("http://13.61.236.139:5000/api/raporlar/en-cok-satanlar")
    ...
    axios.get("http://13.61.236.139:5000/api/raporlar/stok-satis")
    ...
    axios.get("http://13.61.236.139:5000/api/raporlar/performans")
