...
const Anasayfa = () => {
  ...
  useEffect(() => {
    axios.get("http://13.61.236.139:5000/api/kart/kar-zarar").then((res) => setKarZarar(res.data.karZarar));
    axios.get("http://13.61.236.139:5000/api/kart/en-cok-satilan").then((res) => setCokSatilanlar(res.data.urunler));
    axios.get("http://13.61.236.139:5000/api/kart/en-az-stok-urun").then((res) => setAzStokUrunler(res.data.urunler));
    axios.get("http://13.61.236.139:5000/api/kart/en-az-stok-demirbas").then((res) => setAzStokDemirbaslar(res.data.demirbaslar));
  }, []);
